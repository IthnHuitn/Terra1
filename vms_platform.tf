...
#   type        = number
#   default     = 50
#   description = "Core fraction for web VM (20, 50, 100 only for standard-v4a)"
# }
...
#   type        = number
#   default     = 20
#   description = "Core fraction for db VM (20, 50, 100 only for standard-v4a)"
# }
